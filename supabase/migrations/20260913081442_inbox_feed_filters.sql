-- Flat Inbox: date, sorting and classification filters on the complete result set.
-- Keep the legacy RPC intact for existing callers; preserve membership and source guards.
create function public.get_inbox_feed_page(
